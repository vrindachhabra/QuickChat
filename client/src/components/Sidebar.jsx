      ...
      <div className='pb-5'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='relative py-2 group'> 
            {/* group - if parent reacts, children react too, eg- hovering over a card */}
            <img src={assets.menu_icon} alt="Menu" className='max-h-5 cursor-pointer' />
            <div className='absolute top-full right-0 z-20 q-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block'>
